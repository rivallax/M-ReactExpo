...
const JualBarang = () => {
  ...
  const [barangList, setBarangList] = useState([
    ...
    {id: 3, namaBarang: 'Lemari', hargaMasuk: '80000', hargaJual: '100000'},
    {id: 3, namaBarang: 'AC', hargaMasuk: '40000', hargaJual: '80000'},
    {id: 3, namaBarang: 'Laptop', hargaMasuk: '70000', hargaJual: '90000'},
  ]);
  ...
  const handlePilihBarang = item => {
    ...
    if (item.namaBarang === 'Meja' && item.hargaJual === '40000') {
      ...
      // Menghapus lemari dari list setelah dibeli
      const updatedList = barangList.filter(barang => barang.id !== item.id);
      setBarangList(updatedList);
      Alert.alert('Anda telah membeli Lemari');
    } else {
